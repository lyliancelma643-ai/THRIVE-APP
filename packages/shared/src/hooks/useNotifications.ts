...
export function useNotifications() {
  ...
  useEffect(() => {
    ...
    // Souscription Realtime : nouvelles notifs en temps réel
    ...
    // Écouter les taps sur les notifications reçues
    listenerRef.current = Notifications.addNotificationResponseReceivedListener((response) => {
      ...
      // La navigation depuis ici est gérée dans le composant racine via useRouter
    });
