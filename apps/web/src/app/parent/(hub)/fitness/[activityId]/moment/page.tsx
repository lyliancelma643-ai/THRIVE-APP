...
// Route : /parent/fitness/maison/[activityId]/moment?duree=10|20|30&lieu=maison|exterieur|voiture
...
function MomentPage() {
  ...
  return (
    <P3Frame>
      {(ctx) => {
        if (!activity || !allowed || activity.week > ctx.data.openWeek) {
          return (
        ...
        return <ActivityMode ctx={ctx} activity={activity} duration={duration} place={safePlace} />;
      }}
    </P3Frame>
  );
}
