  ...
  return (
    <div className="max-w-7xl mx-auto h-[calc(100vh-80px)] flex flex-col">
      <div className="flex justify-between items-end mb-6 shrink-0">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 mb-1">Familles</h1>
          <p className="text-gray-500 text-sm">{families.length} famille{families.length > 1 ? 's' : ''}</p>
        </div>
        <input
                ...
                filtered.map((family) => (
                  <tr key={family.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">{family.profiles?.email}</div>
                    </td>
