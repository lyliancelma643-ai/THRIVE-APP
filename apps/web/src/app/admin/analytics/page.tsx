                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex-1 bg-gray-100 rounded-full h-2 w-16">
                          <div
                            ...
                            style={{ width: `${c.completion_rate ?? 0}%` }}
                          />
                        </div>
              ...
              <tbody>
                {childProgress.map((child) => (
                  <tr key={child.child_id} className="border-t border-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm font-medium text-green-600">{child.completed_sessions}</span>
                    </td>
                    <td className="px-6 py-4">
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {badge.category && (
                      <p className="text-xs text-gray-400 capitalize">{badge.category}</p>
                    )}
                  </div>
                </div>
