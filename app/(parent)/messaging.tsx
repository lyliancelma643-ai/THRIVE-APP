    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Votre coach</Text>
        </View>
        {loading ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>Les messages de votre coach apparaîtront ici</Text>
          </View>
        ) : (
          <FlatList
            data={conversations}
            ...
            renderItem={({ item }: { item: Conversation }) => (
              <TouchableOpacity style={styles.convItem} onPress={() => openConversation(item.id)}>
                <View style={styles.avatarContainer}>
                  {item.other_user?.avatar_url ? (
                    ...
                    <View style={[styles.avatarPlaceholder, { backgroundColor: '#D1FAE5' }]}>
                      <Text style={[styles.avatarInitial, { color: '#10B981' }]}>
                ...
                <View style={styles.convInfo}>
                  <View style={styles.convRow}>
                    <Text style={styles.convName}>{item.other_user?.full_name || 'Coach'}</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.chatHeader}>
        ...
        <Text style={styles.chatTitle}>{activeConv?.other_user?.full_name || 'Mon Coach'}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  myBubble: { alignSelf: 'flex-end', backgroundColor: '#10B981', borderBottomRightRadius: 4 },
